...
pub struct DecodeOutcome {
    ...
    /// All tokens generated by this decode, in order. Needed by the
    /// catnix receipt path to construct a `TokenIds` Value.
...
pub fn run_cached_program_streaming(
    ...
    if !matches!(stop_reason, StopReason::Cancelled) {
        program.cache_continuation(start.commitment_id, output_tokens, receipt_cid, stop_reason);
    }
